...
describe('Request-Promise-Any', function () {
    ...
    describe('should expose', function () {
        ...
        it('.promise() returning a Q promise', function () {

            var p = rp('http://localhost:4000/200').promise();

            // expect(Q.isPromise(p)).to.eql(true); // <-- Fails. Whatever...
            expect(Q.isPromiseAlike(p)).to.eql(true);
